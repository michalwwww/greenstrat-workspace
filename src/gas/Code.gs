...
function doPost(e) {
  ...
  try {
    ...
    // 2. Storage in Master Ledger
    writeProjectsToSheet(incomingProjects);
    logToSheet('DATA_STORAGE', null, 'SUCCESS', 'Zapisano ' + incomingProjects.length + ' rekordów w arkuszu Projects.', new Date().getTime() - startTime);
